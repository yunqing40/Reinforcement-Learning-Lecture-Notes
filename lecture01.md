...
* **主体**
  ...
  * **Agent**
  ...
  After action taken, the environment will be updated and it will provide the updated reward and observation as new inputs to the agent for the next step.
